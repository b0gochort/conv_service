...
func (s *cryptoService) CreatePasswordHash(plainPassword string) (hashedPassword string, err error) {
...
func (s *cryptoService) ValidatePassword(hashedPassword, plainPassword string) (isValid bool) {
...
func (s *cryptoService) CreateMD5Hash(plainText string) (hashedText string) {
